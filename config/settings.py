"""
Django settings for Gestion de Stock.
Configuration simplifiée pour une meilleure maintenabilité.
"""
...
# Sécurité
SECRET_KEY = 'django-insecure-gj8bvr$-27+dquq!f)be+y*sdoduw@w95xhog_hb8debbzj!h)'
DEBUG = True
ALLOWED_HOSTS = ['*']
...
INSTALLED_APPS = [
    ...
    'stock.apps.StockConfig',  # Application stock avec modèle utilisateur personnalisé
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.contrib.auth.context_processors.auth',
                'django.contrib.messages.context_processors.messages',
                'stock.context_processors.notifications',
            ],
        },
    },
]
